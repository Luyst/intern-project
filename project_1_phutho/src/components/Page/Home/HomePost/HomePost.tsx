...
function HomePost({ data }: { data: any }) {
    return (
        <div className="homePostContainer flex flex-col sm:p-12 p-4 gap-6 bg-secondary-background w-full items-center">
            <div className="title flex flex-col items-center gap-3">
                <div className="subTitle uppercase text-xs md:text-xl font-semibold text-white">CHIA SẺ THÔNG TIN</div>
                <div className="mainTitle text-xl md:text-5xl text-title font-bold text-blue-600">Bài viết mới</div>
                <div className="devide bg-blue-600 h-1.5 w-36 rounded-full"></div>
                <div className="text-gray-50 md:text-xl text-sm text-center ">
