...
function HomeService({ data }: { data: any }) {
    return (
        <div className="bg-white bg-opacity-80 flex flex-col p-12 gap-6 items-center">
            <div className="title flex flex-col items-center gap-3">
                <div className="subTitle uppercase text-xl font-semibold text-gray-600">LĨNH VỰC HOẠT ĐỘNG</div>
                <div className="mainTitle text-5xl text-title font-bold text-blue-600">Các dịch vụ trọng tâm</div>
